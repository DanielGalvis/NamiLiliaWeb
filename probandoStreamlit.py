...
# Función para rotar las imagenes:
# Función para rotar imágenes
def rotate_image(image_path, angle):
    image = Image.open(image_path)
    return image.rotate(angle, expand=True)

### Vamos a hacer una página web sencilla para probar StreamLit
#st.title("Portafolio")
...
with col1:
    ...
    # Imagen No. 3
    imagen = rotate_image(fotos_nami[2], 0)  # Ajusta el ángulo según sea necesario
    st.image(imagen, caption="¡En la playa con mucho calor!")

    #for imagen in fotos_nami:
    #    imagen = rotate_image(imagen, 90)  # Ajusta el ángulo según sea necesario
    #    st.image(imagen, caption="¡Nami en su primer cumpleaños!")
...
with col2:
    ...
    # Imagen No. 2
    imagen = rotate_image(fotos_lilia[3], 0)  # Ajusta el ángulo según sea necesario
